...
ghost-role-information-maint-spider-rules = You are a [color={role-type-team-antagonist-color}][bold]{roles-antag-generic-free-agent-name}[/bold][/color], cooperate with all other maintenance spiders to multiply.
